...
const LANG = {
  ru: {
    ...
    defs_intro:'В модели v4 используется 4-стадийная модель сингулярности на основе двухмерной шкалы (Reasoning, Agency). Пороги T1–T4 настраиваются через Expert Sandbox.',
  ...
  en: {
    ...
    defs_intro:'The v4 model uses a 4-stage singularity framework based on a two-dimensional scale (Reasoning, Agency). T1–T4 thresholds are configurable via Expert Sandbox.',
