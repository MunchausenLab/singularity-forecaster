...
class BayesianTracker {
  ...
  runMonteCarloForecast(nRuns) {
    ...
    return {
        agiYears, asiYears,
        trajectory: { years: yrs, median: med, p10: p10a, p25: p25a, p75: p75a, p90: p90a, agiThreshold: 10, asiThreshold: 25 }
    };
  }
...
function plotScenarioFan(tracker) {
  ...
  traces.push(
    ...
    { x: yrRange, y: [25, 25], type: 'scatter', mode: 'lines', name: t.ch_legend_asi, line: { color: '#ef4444', dash: 'dot', width: 1 } }
  );
